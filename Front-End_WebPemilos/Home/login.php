        ...
        <form novalidate>
          <div class="form-group">
            ...
            <div class="input-icon">
              ...
              <input type="text" id="nama-lengkap" placeholder="Masukkan username/NIS" required />
            </div>
          </div>

          <div class="form-group">
            <label for="token">NISN/NIS</label>
            <div class="input-icon">
              <!-- Ikon hashtag -->
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#800000" viewBox="0 0 24 24" style="position:absolute; left:12px; top:50%; transform:translateY(-50%); opacity:0.5;">
              ...
              <input type="password" id="token" placeholder="Masukkan Token" required />
            </div>
          </div>
